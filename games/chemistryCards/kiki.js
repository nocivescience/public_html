class AudioController {
    constructor() {
        this.bgMusic1 = new Audio('Assets/Audio/despasito.mp3');
        this.bgMusic2 = new Audio('Assets/Audio/blinding.mp3');
        this.myList=[this.bgMusic1,this.bgMusic2];
        ...
        this.myTheme=this.myList[Math.floor(Math.random()*this.myList.length)];
        this.myTheme.volume = 0.5;
        this.myTheme.loop = true;
    }
    startMusic() {
        this.myTheme.play();
    }
